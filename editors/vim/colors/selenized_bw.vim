...
" Last Updated: Fri 15 Nov 2024 02:43:03 AM EST
...
if &background ==# 'dark'
  ...
  hi NormalFloat guifg=NONE guibg=#252525 gui=NONE cterm=NONE
  hi WinBar guifg=#dedede guibg=#252525 gui=bold cterm=bold
  hi WinBarNC guifg=#dedede guibg=#252525 gui=bold cterm=bold
  ...
  hi LspInlayHint guifg=#777777 guibg=NONE gui=NONE cterm=NONE
  ...
  hi RedrawDebugClear guifg=NONE guibg=#efc541 gui=reverse cterm=reverse
  hi RedrawDebugComposed guifg=NONE guibg=#83c746 gui=reverse cterm=reverse
  hi RedrawDebugRecompose guifg=NONE guibg=#ff5e56 gui=reverse cterm=reverse
  hi FloatShadow guifg=NONE guibg=#252525 gui=NONE cterm=NONE
  hi FloatShadowThrough guifg=NONE guibg=#252525 gui=NONE cterm=NONE
  ...
  hi! link StatusLineTerm StatusLine
  hi! link StatusLineTermNC StatusLineNC
  hi NormalFloat guifg=NONE guibg=#ebebeb gui=NONE cterm=NONE
  hi WinBar guifg=#282828 guibg=#ebebeb gui=bold cterm=bold
  hi WinBarNC guifg=#282828 guibg=#ebebeb gui=bold cterm=bold
  ...
  hi LspInlayHint guifg=#878787 guibg=NONE gui=NONE cterm=NONE
  hi! link @conditional Conditional
  hi! link @define Define
  hi! link @diff.delta DiffChange
  hi! link @diff.minus DiffDelete
  ...
  hi! link @variable Identifier
  hi! link @exception Exception
  hi RedrawDebugClear guifg=NONE guibg=#af8500 gui=reverse cterm=reverse
  hi RedrawDebugComposed guifg=NONE guibg=#008400 gui=reverse cterm=reverse
  hi RedrawDebugRecompose guifg=NONE guibg=#bf0000 gui=reverse cterm=reverse
  hi FloatShadow guifg=NONE guibg=#ebebeb gui=NONE cterm=NONE
  hi FloatShadowThrough guifg=NONE guibg=#ebebeb gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi WinBar ctermfg=253 ctermbg=235 cterm=bold
    hi WinBarNC ctermfg=253 ctermbg=235 cterm=bold
    ...
    hi FloatShadow ctermfg=NONE ctermbg=235 cterm=NONE
    hi FloatShadowThrough ctermfg=NONE ctermbg=235 cterm=NONE
    ...
    hi! link StatusLineTerm StatusLine
    hi! link StatusLineTermNC StatusLineNC
    hi NormalFloat ctermfg=NONE ctermbg=255 cterm=NONE
    hi WinBar ctermfg=235 ctermbg=255 cterm=bold
    hi WinBarNC ctermfg=235 ctermbg=255 cterm=bold
    ...
    hi LspInlayHint ctermfg=102 ctermbg=NONE cterm=NONE
    hi! link @conditional Conditional
    hi! link @define Define
    hi! link @diff.delta DiffChange
    hi! link @diff.minus DiffDelete
    ...
    hi RedrawDebugRecompose ctermfg=NONE ctermbg=124 cterm=reverse
    hi FloatShadow ctermfg=NONE ctermbg=255 cterm=NONE
    hi FloatShadowThrough ctermfg=NONE ctermbg=255 cterm=NONE
